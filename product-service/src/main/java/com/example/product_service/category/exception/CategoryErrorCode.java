...
public enum CategoryErrorCode implements ErrorCode {
    CATEGORY_NOT_FOUND(ErrorCategory.NOT_FOUND, "CATEGORY_NOT_FOUND", "카테고리를 찾을 수 없습니다"),
    ...
    CATEGORY_HAS_CHILD(ErrorCategory.BUSINESS_CONFLICT, "CATEGORY_HAS_CHILD", "해당 카테고리의 하위 카테고리가 존재합니다"),
    CATEGORY_HAS_PRODUCT(ErrorCategory.BUSINESS_CONFLICT, "CATEGORY_HAS_PRODUCT", "해당 카테고리에 속한 상품이 존재합니다"),
