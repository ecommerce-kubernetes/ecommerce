...
public enum CategoryErrorCode implements ErrorCode {
    ...
    EXCEED_MAX_DEPTH(ErrorCategory.BUSINESS_CONFLICT, "CATEGORY_004", "더이상 해당 부모 카테고리에는 자식 카테고리를 생성할 수 없습니다"),
    ...
    CANNOT_MOVE_TO_SELF(ErrorCategory.BUSINESS_CONFLICT, "CATEGORY_007", "잘못된 부모 설정입니다"),
    CATEGORY_ID_IS_NULL(ErrorCategory.SYSTEM_ERROR, "CATEGORY_008", "카테고리 id가 설정되지 않았습니다"),
    CANNOT_MOVE_TO_DESCENDANT(ErrorCategory.NOT_FOUND, "CATEGORY_009", "카테고리를 자신의 하위로 이동할 수 없습니다");
