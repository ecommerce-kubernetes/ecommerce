...
public class ReviewController {
    ...
    public ResponseEntity<ReviewResponse> createReview(@PathVariable("productId") Long productId,
    ...
    public ResponseEntity<PageDto<ReviewResponse>> getReviewsByProductId(@PathVariable("productId") Long productId,
        ...
        PageDto<ReviewResponse> result = reviewService.getReviewList(productId, pageable);
