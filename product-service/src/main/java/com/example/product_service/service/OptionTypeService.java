...
public interface OptionTypeService {
    OptionTypeResponse saveOptionType(OptionTypeRequest request);
    OptionValueResponse saveOptionValue(Long optionTypeId, OptionValueRequest request);
    ...
    List<OptionValueResponse> getOptionValuesByTypeId(Long optionTypeId);
}
