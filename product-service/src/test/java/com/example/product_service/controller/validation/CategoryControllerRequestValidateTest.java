...
public class CategoryControllerRequestValidateTest {
    ...
    private static final String NAME_FIELD_PATH = "category.name.notBlank";
    private static final String IMAGE_URL_FIELD_PATH = "category.iconUrl.invalid";
    ...
    static Stream<Arguments> invalidCategoryRequestFieldProvider(){
        return Stream.of(
                Arguments.of("name", "", getMessage(NAME_FIELD_PATH)),
                Arguments.of("iconUrl", INVALID_URL, getMessage(IMAGE_URL_FIELD_PATH))
        );
    }
