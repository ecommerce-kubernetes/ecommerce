...
class AuthControllerTest {
    ...
    void refresh_whenMissingRefreshToken_thenThrownException() throws Exception {
        //given
        //when
        //then
        mockMvc.perform(post("/auth/refresh")
    ...
    @Test
    @DisplayName("리프레시 토큰이 빈 문자열인 경우 예외가 발생한다.")
    void refresh_whenRefreshTokenIsBlank_thenThrownException() throws Exception {
        //given
        //when
        //then
        mockMvc.perform(post("/auth/refresh")
