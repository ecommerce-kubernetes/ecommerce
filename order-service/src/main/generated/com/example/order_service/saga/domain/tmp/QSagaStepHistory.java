...
public class QSagaStepHistory extends EntityPathBase<SagaStepHistory> {
    ...
    private static final long serialVersionUID = 1841110250L;
    ...
    public final EnumPath<com.example.order_service.saga.domain.SagaStep> step = createEnum("step", com.example.order_service.saga.domain.SagaStep.class);
