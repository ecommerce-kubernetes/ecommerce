...
public class QOrderSagaInstance extends EntityPathBase<OrderSagaInstance> {
    ...
    private static final long serialVersionUID = -2072839993L;
    ...
    public final SimplePath<com.example.order_service.order.saga.domain.model.vo.Payload> payload = createSimple("payload", com.example.order_service.order.saga.domain.model.vo.Payload.class);
