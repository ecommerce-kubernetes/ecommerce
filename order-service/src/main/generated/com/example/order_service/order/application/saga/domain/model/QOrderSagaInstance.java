package com.example.order_service.order.application.saga.domain.model;
...
public class QOrderSagaInstance extends EntityPathBase<OrderSagaInstance> {
    ...
    private static final long serialVersionUID = -704038999L;
    ...
    public final SimplePath<com.example.order_service.order.application.saga.domain.model.vo.Payload> payload = createSimple("payload", com.example.order_service.order.application.saga.domain.model.vo.Payload.class);
