...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = -1692559873L;
    ...
    public final QAppliedCartCoupon appliedCartCoupon;
    ...
    public final QOrderAmount orderAmount;

    public final QOrderCancelInfo orderCancelInfo;
    ...
    public QOrder(Class<? extends Order> type, PathMetadata metadata, PathInits inits) {
        ...
        this.appliedCartCoupon = inits.isInitialized("appliedCartCoupon") ? new QAppliedCartCoupon(forProperty("appliedCartCoupon")) : null;
        this.orderAmount = inits.isInitialized("orderAmount") ? new QOrderAmount(forProperty("orderAmount")) : null;
        this.orderCancelInfo = inits.isInitialized("orderCancelInfo") ? new QOrderCancelInfo(forProperty("orderCancelInfo")) : null;
