...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    public final QAppliedItemCoupon appliedItemCoupon;
    ...
    public final QOrderItemAmount orderItemAmount;
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.appliedItemCoupon = inits.isInitialized("appliedItemCoupon") ? new QAppliedItemCoupon(forProperty("appliedItemCoupon")) : null;
        this.order = inits.isInitialized("order") ? new QOrder(forProperty("order"), inits.get("order")) : null;
        this.orderItemAmount = inits.isInitialized("orderItemAmount") ? new QOrderItemAmount(forProperty("orderItemAmount")) : null;
