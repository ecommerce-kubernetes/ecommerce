...
public class OrderCouponMapperImpl implements OrderCouponMapper {
    ...
    @Override
    public CartCouponSnapshot toCartCouponSnapshot(CouponClientResponse.CartCoupon response) {
        if ( response == null ) {
            return null;
        }
        ...
        cartCouponSnapshot.couponId( response.couponId() );
        cartCouponSnapshot.couponName( response.couponName() );
        cartCouponSnapshot.discountAmount( moneyMapper.toMoney( response.discountAmount() ) );
    ...
    @Override
    public ItemCouponSnapshot toItemCouponSnapshot(CouponClientResponse.ItemCoupon response) {
        if ( response == null ) {
            return null;
        }

        ItemCouponSnapshot.ItemCouponSnapshotBuilder itemCouponSnapshot = ItemCouponSnapshot.reconstitute();

        itemCouponSnapshot.discountAmount( moneyMapper.toMoney( response.discountAmount() ) );

        return itemCouponSnapshot.build();
    }
