...
import com.example.order_service.order.infrastructure.adaptor.out.client.mapper.OrderCouponAdaptorMapper;
...
public class OrderCouponAdaptor implements OrderCouponPort {
    ...
    private final OrderCouponAdaptorMapper orderCouponAdaptorMapper;
    ...
    public CartCouponResult getCartCoupon(Long userId, Long cartCouponId) {
        ...
        return orderCouponAdaptorMapper.mapToCartCouponResult(response);
    }
    ...
    public ItemCouponsResult getItemCoupons(Long userId, List<Long> itemCouponIds) {
        ...
        return orderCouponAdaptorMapper.mapToItemCouponsResult(response);
    }
