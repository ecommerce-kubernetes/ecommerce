...
public class PgErrorTranslator implements ErrorTranslator {
    ...
    public PaymentErrorCode translate(String code) {
        ...
        return switch (code) {
            ...
            case "ALREADY_CANCELED_PAYMENT", "ALREADY_REFUND_PAYMENT" -> PaymentErrorCode.PAYMENT_ALREADY_CANCELED;

            case "INVALID_REFUND_ACCOUNT_INFO", "INVALID_REFUND_ACCOUNT_NUMBER",
                 "INVALID_BANK", "FORBIDDEN_BANK_REFUND_REQUEST" -> PaymentErrorCode.PAYMENT_INVALID_REFUND_ACCOUNT;
            ...
            case "EXCEED_CANCEL_AMOUNT_DISCOUNT_AMOUNT", "NOT_MATCHES_REFUNDABLE_AMOUNT",
                 ...
                 "EXCEED_CANCEL_LIMIT" -> PaymentErrorCode.PAYMENT_CANCEL_REJECTED;
