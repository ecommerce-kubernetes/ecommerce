...
public enum PaymentErrorCode implements ErrorCode {
    ...
    PAYMENT_CANNOT_CANCEL(HttpStatus.CONFLICT, "PAYMENT_CANNOT_CANCEL", "결제를 취소 할 수 없는 결제 입니다."),
    ...
    CANCEL_AMOUNT_MISMATCH(HttpStatus.INTERNAL_SERVER_ERROR, "CANCEL_AMOUNT_MISMATCH", "PG 환불 금액이 일치하지 않습니다"),
