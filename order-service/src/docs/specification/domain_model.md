...
- 쿠폰 적용: 장바구니 쿠폰을 주문서에 적용한다.

#### 규칙

- 주문서를 생성할 때 주문 상품 정보를 토대로 총 상품 가격, 총 상품 할인 가격, 총 결제 금액이 계산된다.
- 주문서를 생성할 때 주문자 정보가 필요하다.
- 주문서를 생성할 때 하나 이상의 주문 상품 정보가 필요하다.
- 주문서를 생성할 때 만료시간이 필요하다.
- 주문서에 장바구니 쿠폰을 적용하면 가격 정보가 재 계산된다.
...
- 상품 쿠폰 적용: 상품 쿠폰을 적용한다.
- 총 원 가격 계산: 주문 항목의 상품 원 가격과 주문 수량을 곱한 총 상품 원 가격을 계산한다.
- 총 상품 할인 금액 계산: 주문 항목의 상품 할인 금액과 주문 수량을 곱한 총 상품 할인 금액을 계산한다.
- 총 상품 가격 계산: 주문 항목의 상품 판매 가격과 주문 수량을 곱한 총 상품 가격을 계산한다.
