package com.example.order_service.order.infrastructure.adaptor.out.client.mapper;
...
class OrderUserAdaptorMapperTest {

    private final OrderUserAdaptorMapper orderUserAdaptorMapper = new OrderUserAdaptorMapper();
    ...
    void mapToOrdererProfileResult(){
        ...
        UserProfileResponse response = UserProfileResponse.builder()
                ...
                .build();
        //when
        OrdererProfileResult result = orderUserAdaptorMapper.mapToOrdererProfileResult(response);
        //then
    ...
    void mapToOrdererPointResult(){
        ...
        UserPointsResponse response = UserPointsResponse.builder()
                ...
                .build();
        //when
        OrdererPointResult result = orderUserAdaptorMapper.mapToOrdererPointResult(response);
        //then
