...
public class OrderDescriptor {
    ...
    public static FieldDescriptor[] getOrderDetailResponse() {
        return new FieldDescriptor[] {
                ...
                fieldWithPath("orderItems[].options[].optionTypeName").description("주문 상품 옵션 타입"),
                fieldWithPath("orderItems[].options[].optionValueName").description("주문 상품 옵션 이름"),
    ...
    public static FieldDescriptor[] getOrderSummaryResponse() {
        return new FieldDescriptor[] {
                ...
                fieldWithPath("content[].orderItems[].options[].optionTypeName").description("주문 상품 옵션 타입"),
                fieldWithPath("content[].orderItems[].options[].optionValueName").description("주문 상품 옵션 이름"),
